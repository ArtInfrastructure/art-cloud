...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field documents on 'Installation'
        db.create_table('front_installation_documents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('installation', models.ForeignKey(orm['front.installation'], null=False)),
            ('document', models.ForeignKey(orm['front.document'], null=False))
        ))
        db.create_unique('front_installation_documents', ['installation_id', 'document_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field documents on 'Installation'
        db.delete_table('front_installation_documents')
    ...
    models = {
        ...
        'front.installation': {
            ...
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['front.Document']", 'null': 'True', 'blank': 'True'}),
