...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('front_document', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Document.title'
        db.alter_column('front_document', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))
